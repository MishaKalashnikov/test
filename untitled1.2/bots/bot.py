...
import asyncio
import logging
from utils.database import get_channels_by_type  # Загружаем стримеров с открытым чатом

# 🔥 ДАННЫЕ БОТА
BOT_NICK = "atiila3301"  # Имя бота (замени на своё)
BOT_TOKEN = "oauth:b1clnc3xiwl61eccxo1y1h6cgbw5wy"  # Твой OAuth-токен
...
MESSAGES = [
    ...
    "do you play faceit?",
    "go next one?",
    "maybe y can send your steam faceit or discord?",
    "Dude?",
    "?",
    "?"
]
